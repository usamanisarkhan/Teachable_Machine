Note : Students to please use Gmail ID' for creation of Github account. Procedure for making a github account is mentioned **[[Here]]([https://teachablemachine.withgoogle.com/models/qlqjwznH-/](https://www.youtube.com/watch?v=Gn3w1UvTx0A))**
